...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |Adjust| RCtrl| Alt  | GUI  | EISU | EISU |Space | Bksp | KANA |   '  |   [  |   ]  |   `  |  |   |
   * `-------------------------------------------------------------------------------------------------'
   */
  [_QWERTY] = LAYOUT( \
      ...
      KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    LOWER ,   RAISE , KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_MINS , \
      ADJUST, KC_RCTL,  KC_LALT, KC_LGUI, EISU,    EISU,   KC_SPC,  KC_BSPC, KANA ,   KC_QUOT,  KC_LBRC, KC_RBRC, KC_GRV,   KC_PIPE \
      ),
   ...
   * |      |      |      |      |      |      |      |      |      |      |RGB ON| HUE+ | SAT+ | VAL+ |
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |      |      |      |      |      | LEFT |  Up  | DOWN | Right |      | MODE | HUE- | SAT- | VAL- |
   * `-------------------------------------------------------------------------------------------------'
   */
  [_ADJUST] =  LAYOUT( \
      ...
      _______, _______, _______, _______, _______, KC_LEFT,  KC_UP , KC_DOWN, KC_RGHT, _______, RGB_SMOD,RGB_HUD, RGB_SAD, RGB_VAD \
      )
};
