...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |Adjust| Alt  |  GUI | EISU | DEL  |Space |Bksp  |KANA  |Enter |   <  |   >  |  [   |   ]  |   `  |
   * `-------------------------------------------------------------------------------------------------'
   */
  [_QWERTY] = LAYOUT( \
      ...
      ADJUST,  KC_LALT, KC_LGUI, EISU,    KC_DEL, KC_SPC,  KC_BSPC,  KANA,   KC_ENT,  KC_LABK, KC_RABK, KC_LBRC, KC_RBRC, KC_GRV  \
      ),
   ...
   * |      |      |      |      |      |      |      |      |      |      |RGB ON| HUE+ | SAT+ | VAL+ |
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |      | DEL  |  Alt | Ctrl | HOME | LEFT |  Up  | DOWN |Right | END  | MODE | HUE- | SAT- | VAL- |
   * `-------------------------------------------------------------------------------------------------'
   */
  [_ADJUST] =  LAYOUT( \
      ...
      _______, KC_DEL,  KC_LALT, KC_LCTL, KC_HOME, KC_UP,   KC_LEFT, KC_RGHT, KC_DOWN, KC_END,  RGB_SMOD,RGB_HUD, RGB_SAD, RGB_VAD \
      )
};
