 ...
 *
 * ,--------------------------------------------------.           ,--------------------------------------------------.
 * | ESC    |   1  |   2  |   3  |   4  |   5  | PSCR |           |  \|  |   6  |   7  |   8  |   9  |   0  |   -_    |
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 * | Tab    |   Q  |   W  |   E  |   R  |   T  | LFn  |           | RGUI |   Y  |   U  |   I  |   O  |   P  |   '"   |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * | CTRL   |   A  |   S  |   D  |   F  |   G  |------|           |------|   H  |   J  |   K  |   L  |  ;:  |   =+   |
 * |--------+------+------+------+------+------|TOGGLE|           |CTLALT|------+------+------+------+------+--------|
 * | LShift |   Z  |   X  |   C  |   V  |   B  |MOUSE |           | DEL  |   N  |   M  |  ,<  |  .>  |   /?  |   ^~   |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   | CTRL | Alt  | LFn  | PgUp | LFn  |                                       | Down | PgDn |  [{  |  }]  |   F11  |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
 *                                        | LGui | LAlt |       | Alt  | LFn  |
 *                                 ,------|------|------|       |------+--------+------.
...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        KC_RCTL,        KC_LGUI,      MO(FN),   KC_PGUP,  MO(FN),
                                                KC_LGUI,        KC_LALT,
                                                                KC_HOME,
                                                KC_SPC,KC_BSLS, KC_LEFT,
        // right hand
        KC_BSPC ,            KC_6,   KC_7,   KC_8,   KC_9,   KC_0,             KC_MINS,
        KC_RALT,             KC_Y,   KC_U,   KC_I,   KC_O,   KC_P,             KC_QUOT,
                            KC_H,   KC_J,   KC_K,   KC_L,   KC_SCLN,          KC_EQL,
        LALT(LCTL(KC_DEL)) ,KC_N,   KC_M,   KC_COMM,KC_DOT, KC_SLSH,          KC_ESC,
                                   KC_DOWN, KC_PGDN ,KC_LBRC,KC_RBRC,          KC_F11,
             KC_LALT,        MO(FN),
             KC_END,
...
[FN] = KEYMAP(
       ...
       KC_CAPS,     KC_LNUM,      KC_LANG2,   KC_UP,   KC_LANG4,   KC_LANG5,   KC_TRNS,
       KC_TRNS,     KC_LANG7,    KC_LEFT, KC_DOWN, KC_RIGHT, KC_TRNS,
       ...
       KC_TRNS, KC_1, KC_2, KC_3, KC_4,  KC_5, KC_NLCK,
                KC_6, KC_7, KC_8, KC_9,  KC_0, KC_TRNS,
       KC_TRNS, KC_MINS, KC_DOT, KC_PLUS, KC_SLSH,  KC_ASTER, KC_TRNS,
                KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,  KC_TRNS,
       KC_TRNS, KC_MUTE,
       KC_TRNS,
